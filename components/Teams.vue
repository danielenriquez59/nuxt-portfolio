    ...
    <AppSection>
        <div v-if="resumeType">
            <div class="flex justify-center">
                <h2 class="mb-8 ">Teams I've Worked With </h2>
            </div>
            <div class="flex gap-8 justify-center flex-wrap px-2">
                <img src="~/assets/logos/northrop.png" alt="Northrop Grumman" class="h-11 aspect-auto" />
                <img src="~/assets/logos/talyn.webp" alt="Talyn Air" class="h-9  aspect-auto" />
                <img src="~/assets/logos/rif.png" alt="Research In Flight" class="h-11  aspect-auto" />
                <img src="~/assets/logos/mejzlik.png" alt="Mejzlik Propellers" class="h-11  aspect-auto" />
            </div>
        </div>
        <div v-else>
            <div class="flex justify-center">
                <h2 class="mb-8 ">Codes I've Worked With </h2>
            </div>
            <div class="flex gap-8 justify-center flex-wrap px-2">
